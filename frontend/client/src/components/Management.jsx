...
import { login, port, isAdmin, c} from "../actions";
...
const checkStoresDiv = setInterval(async () => {
    if (document.getElementById("storesList")) {
        ...
        if (c === "undefined") return window.location.replace("/");
...
function App() {
    return (
        <div className="App">
            ...
            <h2 className="text-center py-10 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-3xl dark:text-white">Διαχείριση Μαγαζιών</h2>
